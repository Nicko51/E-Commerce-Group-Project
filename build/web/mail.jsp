<%-- 
    Document   : mail
    Created on : 15 Dec 2023, 23:55:47
    Author     : manju
--%>
			...
			<div class="agileinfo_mail_grids">
				<div class="col-md-4 agileinfo_mail_grid_left">
					<ul>
						...
						<li>address<span>123 Lyon St BvlD PHP.</span></li>
					</ul>
					<ul>
						<li><i class="fa fa-envelope" aria-hidden="true"></i></li>
						<li>email<span><a href="mailto:emailme@grocerystore.com">emailme@grocerystore.com</a></span></li>
					</ul>
					<ul>
						<li><i class="fa fa-phone" aria-hidden="true"></i></li>
						<li>call to us<span>(111) 222 3345</span></li>
					</ul>
				</div>
